...
export class StackedBarChartComponent implements AfterViewInit {
  ...
  private static customPalette = [
    '#66bb6a', '#42a5f5', '#ffca28', '#ab47bc', '#ef5350',
    '#29b6f6', '#ffa726', '#7e57c2', '#26c6da', '#ec407a'
  ];
    ...
    chart.append("g")
      ...
      .attr("d", d => {
        ...
        if (d.isTop) {
          ...
          const r = 4;
          return `M${x0},${y0 + r}a${r},${r} 0 0 1 ${r},-${r}h${barWidth - 2 * r}a${r},${r} 0 0 1 ${r},${r}v${barHeight - r}h${-barWidth}Z`;
        } else {
          // Square corners
